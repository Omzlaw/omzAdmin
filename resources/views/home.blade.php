        ...
        <div class="row">
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-info">
                    <div class="inner">
                        ...
                        <p>Applicants</p>
                        <p><small>{{ $applicant_pending_count }} Pending. {{ $applicant_approved_count }}
                                Approved. {{ $applicant_disapproved_count }} Declined</small></p>
                    </div>
                    <div class="icon">
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-success">
                    ...
                    <a href="{{ route('operators.index') }}" class="small-box-footer">More info <i
                            class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
