...
<head>
    ...
    <title>Home - National Lottery Regulatory Commission</title>
    ...
    <script src="{{ asset('landing-custom/js/scrollreveal.min.js') }}"></script>
</head>
...
<body class="is-boxed has-animations">
            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
                        <div class="hero-copy">
                            <h1 class="hero-title mt-0">NLRC</h1>
                            <p class="hero-paragraph">National Lottery Regulatory Commission</p>
                            <div class="row">
                                <span class="col-sm-12"><a style=" background-color: #86C127" class="button button-shadow"
                                    href="{{ route('login') }}">Login</a></span>
                                <span class="col-sm-12"> <a class="button button-primary button-shadow"
                                    href="{{ route('applicants.apply') }}">Apply</a></span>
                            </div>
                        ...
                        <div class="hero-app">
                            ...
                            <img class="device-mockup" src="{{ asset('landing-custom/images/iphone-mockup.png') }}"
                                alt="App preview">
    ...
    <script src="{{ asset('landing-custom/js/main.min.js') }}"></script>
</body>
