            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0">Omz Admin</h1>
	                        <p class="hero-paragraph">CRUD Template to speed up development process</p>
	                        <div class="hero-cta"><a class="button button-shadow" href="{{ route('login') }}">Login</a><a class="button button-primary button-shadow" href="{{ route('register') }}">Register</a></div>
						</div>
						<div class="hero-app">
							...
							<img class="device-mockup" src="{{ asset('landing-custom/images/iphone-mockup.png') }}" alt="App preview">
