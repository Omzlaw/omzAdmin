...
<!-- Shareholders Details Field -->
{{-- <div class="form-group col-sm-12 col-lg-12">
    {!! Form::label('shareholders_details', 'Shareholders Details:') !!}
    {!! Form::textarea('shareholders_details', null, ['class' => 'form-control']) !!}
</div> --}}
...
{{-- <div class="form-group col-sm-12 col-lg-12">
    ...
    {!! Form::textarea('directors_details', null, ['class' => 'form-control']) !!}
</div> --}}
...
<!-- Owners Convicted Field -->
{{-- <div class="form-group col-sm-6">
    {!! Form::label('owners_convicted', 'Owners Convicted:') !!}
    {!! Form::select('owners_convicted', ['1' => 'Yes', '0' => 'No'], null, ['class' => 'form-control custom-select']) !!}
</div> --}}
...
<!-- Is Director Politician Field -->
{{-- <div class="form-group col-sm-6">
    {!! Form::label('Is_director_politician', 'Is Director Politician:') !!}
    {!! Form::select('Is_director_politician', enum_yes_no(), null, ['class' => 'form-control custom-select']) !!}
</div> --}}
...
<!-- Is Shareholder Politician Field -->
{{-- <div class="form-group col-sm-6">
    {!! Form::label('is_shareholder_politician', 'Is Shareholder Politician:') !!}
    {!! Form::select('is_shareholder_politician', enum_yes_no(), null, ['class' => 'form-control custom-select']) !!}
</div> --}}
