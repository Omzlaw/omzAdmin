    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <a class="btn btn-default float-right" href="{{ route('applicants.dashboard') }}">
                        Back
                    </a>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <table class="table table-default table-striped">
                            @include('applicants.application_details_fields')

                        </table>
                    </div>
                    <div class="col-sm-6">
                        <table class="table table-default table-striped">
                            @include('applicants.application_details_fields2')
