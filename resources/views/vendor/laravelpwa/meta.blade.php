...
<script type="text/javascript">
    ...
    if ('serviceWorker' in navigator) {
        navigator.serviceWorker.register("{{ asset('serviceworker.js') }}", {
            ...
            console.log('Omz Admin PWA: ServiceWorker registration successful with scope: ', registration.scope);
        }, function (err) {
            // registration failed :(
            console.log('Omz Admin PWA: ServiceWorker registration failed: ', err);
        });
    }
</script>